...
WHERE TABLE_NAME = 'Mays Limited Sales'


-- Drop Country Column

ALTER TABLE [Mays Limited].[dbo].[Mays Limited Sales]
DROP COLUMN Country

-- Calculate Number of Days to Ship Product and Create Column 

ALTER TABLE [dbo].[Mays Limited Sales]
ADD Shipping_Days SMALLINT;

UPDATE [Mays Limited Sales]
